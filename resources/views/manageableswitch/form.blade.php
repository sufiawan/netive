        ...
        <div class="card-body">
        	...
        	<div class="tab-content" id="myTabContent">
            	<div class="tab-pane show active mb-1" id="general">
                	@if($data->id)
                        {!! Form::open(['route' => ['manageableswitch.update', $data->id]]) !!}
                        {{ Form::hidden('_method', 'PUT') }}
                    @else
                        {!! Form::open(['route' => 'manageableswitch.store']) !!}
                    @endif
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <a href="/manageableswitch" class="btn btn-secondary">Back</a>
                            </div>
                        </div>            
                    {!! Form::close() !!}
            	</div>
