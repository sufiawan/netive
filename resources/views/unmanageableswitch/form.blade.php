...
@section('content')
    <div class="pb-2 mb-2"><h2>Unmanageable Switch</h2></div>
    <div class="card">
        <div class="card-body">
            @if($data->id)
        	...
        	<div class="tab-content" id="myTabContent">
            	<div class="tab-pane show active mb-1" id="general">
                	@if($data->id)
                        {!! Form::open(['route' => ['unmanageableswitch.update', $data->id]]) !!}
                        {{ Form::hidden('_method', 'PUT') }}
                    @else
                        {!! Form::open(['route' => 'unmanageableswitch.store']) !!}
                    @endif
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <a href="/unmanageableswitch" class="btn btn-secondary">Back</a>
                            </div>
                        </div>            
                    {!! Form::close() !!}
            	</div>
