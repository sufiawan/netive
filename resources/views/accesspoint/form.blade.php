            ...
            @endif
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input id="brand" type="text" class="form-control{{ $errors->has('string') ? ' is-invalid' : '' }}" name="brand" value="{{ old('brand', $accesspoint->brand) }}" placeholder="brand" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="type" type="text" class="form-control{{ $errors->has('string') ? ' is-invalid' : '' }}" name="type" value="{{ old('type', $accesspoint->type) }}" placeholder="type" required>
                        @if ($errors->has('string'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('string') }}</strong>
                            </span>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="ip_address" type="text" class="form-control{{ $errors->has('string') ? ' is-invalid' : '' }}" name="ip_address" value="{{ old('ip_address', $accesspoint->ip_address) }}" placeholder="ip address">
