    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <a href="/firewall/create" class="btn btn-primary">Create</a>
            </div>
                ...
                <table id="tbldata" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div><a href="/firewall/{{ $data->id }}/edit" class="btn btn-sm btn-primary mr-1">Edit</a><button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete({{ $data->id }});">Delete</button></div></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        function confirmDelete(id) {
            bootbox.confirm("Are you sure want to delete?", function(result) {
                if (result) {
                    $('#delete-form').attr('action', '/firewall/' + id);
                    $('#delete-form').submit();
                }
            })
        }
